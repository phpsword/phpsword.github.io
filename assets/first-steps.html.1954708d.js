import{_ as e,o as s,c as n,e as a}from"./app.0e7e6ab3.js";const i="/images/wordpress-installation.jpg",t="/images/wordpress-dashboard.jpg",l="/images/wordpress-child-theme.jpg",c={},o=a('<h1 id="first-steps" tabindex="-1"><a class="header-anchor" href="#first-steps" aria-hidden="true">#</a> First steps</h1><h2 id="wordpress-installation" tabindex="-1"><a class="header-anchor" href="#wordpress-installation" aria-hidden="true">#</a> WordPress installation</h2><p>When you first access your website, you&#39;ll be redirected to the WordPress installation page.</p><p><img src="'+i+'" alt="WordPress installation page"></p><p>Enter your desired credentials to access the dashboard.</p><p><img src="'+t+`" alt="WordPress dashboard"></p><h2 id="create-a-child-theme" tabindex="-1"><a class="header-anchor" href="#create-a-child-theme" aria-hidden="true">#</a> Create a child theme</h2><p>In your terminal, initialize your child theme:</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token function">mkdir</span> wp/content/themes/mychildtheme
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Then open <code>style.css</code> and fill it with this header, modify to your needs:</p><div class="language-css ext-css line-numbers-mode"><pre class="language-css"><code><span class="token comment">/*
...
</span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Finally, go activate it in WordPress admin.</p><p><img src="`+l+'" alt="WordPress dashboard"></p><p>That&#39;s it. Your child theme is Symfony ready.</p>',18),d=[o];function r(p,u){return s(),n("div",null,d)}const h=e(c,[["render",r],["__file","first-steps.html.vue"]]);export{h as default};
